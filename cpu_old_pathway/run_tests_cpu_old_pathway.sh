...
echo ""
cd /scratch/asharma/hole_cut_reg_tests/cpu_old_pathway/ctv
rm -rf core* plt*
...
echo ""
cd /scratch/asharma/hole_cut_reg_tests/cpu_old_pathway/sphere_w_amr
rm -rf core* plt*
...
echo ""
cd /scratch/asharma/hole_cut_reg_tests/cpu_old_pathway/nrel_5mw
rm -rf core* plt*
