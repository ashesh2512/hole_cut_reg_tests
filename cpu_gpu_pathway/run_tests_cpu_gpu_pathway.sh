...
echo ""
cd /scratch/asharma/amr_reg_test/cpu_gpu_pathway/ctv
rm -rf core* plt*
...
echo ""
cd /scratch/asharma/amr_reg_test/cpu_gpu_pathway/sphere_w_amr
rm -rf core* plt*
...
echo ""
cd /scratch/asharma/amr_reg_test/cpu_gpu_pathway/nrel_5mw
rm -rf core* plt*
